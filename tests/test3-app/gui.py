...
class HandGestureGUI:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Hand Gesture Cursor Controller (test1)")
    ...
    def create_widgets(self):
        ...
        title_label = ttk.Label(title_frame, 
                               text="Hand Gesture Cursor Controller (test1)",
                               style='Title.TLabel')
        title_label.pack()
        
        subtitle_label = ttk.Label(title_frame, 
                                  text="Line-based cursor tracking prototype", 
    ...
    def create_status_section(self, parent):
        ...
        self.add_status("Hand Gesture Controller (test1) initialized. Select a mode and click 'Start' to begin.")
    ...
    def show_help(self):
        help_text = """
Hand Gesture Controls (test1 prototype):

• Cursor uses multiple finger lines (MCP→tip) to compute a stable point
• Double-touch thumb and index finger to perform a left click
• Fold all fingers to pause/idle the cursor

Notes on Clicking:
• Pointer lock prevents drift while touching and shortly after click

Tips:
• Ensure good lighting and keep hand 12-18 inches from camera
